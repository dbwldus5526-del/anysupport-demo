      ...
      <section className="relative pt-40 pb-20 overflow-hidden bg-slate-900 text-white">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/20 border border-primary/30 mb-6 text-[#ffffff]">
        ...
        <div className="max-w-[1280px] w-full mx-auto px-4 sm:px-6 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative flex items-start justify-end lg:pt-0"
            >
              <div className="rounded-2xl overflow-hidden w-full max-w-[520px] border border-slate-200">
                <img
