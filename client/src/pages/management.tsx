    ...
    <div className="flex flex-col">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-slate-900 text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="https://placehold.co/1200x600?text=Management"
            alt="원격지원 관리"
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-400 text-lg mb-8 leading-relaxed">
              관리자 전용 대시보드를 통해 상담원 관리, 보안 정책 설정,
              <br />
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
              <span className="text-primary font-black tracking-widest uppercase mb-4 block">
                ACCOUNT MANAGEMENT
              </span>
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                상담원의 역할(Role)에 따라 메뉴 접근 및 기능 사용 범위를
                세분화하여 설정할 수 있습니다. 부서나 프로젝트 단위로 그룹을
                생성하여 관리 효율성을 극대화합니다.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center flex-row-reverse">
            <div className="lg:order-2">
              ...
              <p className="text-slate-600 mb-8 leading-relaxed">
                ...
                녹화 파일 저장 및 로그 조회를 통해 사후 문제 발생 시 명확한 근거
                자료로 활용 가능합니다.
              </p>
              <ul className="space-y-4">
                {[
        ...
        <div className="container mx-auto px-4 md:px-6 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-8">
              안전하고 체계적인 원격지원 관리의 시작
            </h2>
            <p className="text-slate-500 mb-12 text-lg">
              애니서포트의 강력한 관리자 기능을 통해 운영 비용은 줄이고 보안성은
              높이세요.
            </p>
            <Button
              size="lg"
