    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="relative min-h-[40vh] flex items-center pt-40 pb-20 overflow-hidden bg-slate-900 text-white">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
          <h1 className="text-4xl md:text-6xl text-white mb-6 leading-tight font-bold">사용 방법 안내입니다.</h1>
          <p className="text-lg md:text-xl max-w-4xl mx-auto leading-relaxed text-[#e1e9f0] font-normal">
