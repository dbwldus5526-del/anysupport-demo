      ...
      <section id="what-is-remote" className="py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">원격지원이란 무엇인가요?</h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-lg">현장 방문 없이 온라인으로 문제를 즉시 해결합니다.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="p-8 rounded-2xl bg-slate-50 flex items-start gap-5">
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center text-primary shrink-0">
                <Monitor size={24} />
              </div>
              <div>
                <h3 className="text-xl font-bold mb-2">실시간 화면 공유</h3>
                <p className="text-slate-500 font-medium">고객의 화면을 실시간으로 확인하며 정확한 문제 상황을 파악합니다.</p>
              </div>
            </div>
            <div className="p-8 rounded-2xl bg-slate-50 flex items-start gap-5">
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center text-primary shrink-0">
              ...
              <div>
                <h3 className="text-xl font-bold mb-2">즉각적인 원격 제어</h3>
                <p className="text-slate-500 font-medium">상담원이 직접 기기를 조작하여 설정을 변경하거나 장애를 복구합니다.</p>
              </div>
            </div>
          </div>
        </div>
