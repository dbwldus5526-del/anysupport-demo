          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                ...
                <h3 className="lg:text-xl font-bold mb-3 text-[#333] text-[18px] whitespace-nowrap">
                  {item.title}
                </h3>
      ...
      <section className="py-24 bg-[#ffffff]">
        <div className="max-w-[1280px] w-full mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-10 rounded-2xl border border-slate-200 hover:border-primary transition-all flex flex-col bg-[#ffffff] text-[#333]">
